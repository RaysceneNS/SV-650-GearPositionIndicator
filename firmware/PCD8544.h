...
static const uint8_t degree[] PROGMEM ={0x38, 0x44, 0x44, 0x44, 0x38}; // o
static const uint8_t v[] PROGMEM ={0x1c, 0x20, 0x40, 0x20, 0x1c}; // v
...
void LcdClear(void);
void LcdGliff(const uint8_t *BMP);

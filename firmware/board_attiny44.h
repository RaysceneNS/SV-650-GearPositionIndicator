...
#define DDRA_BOARD 0b1100000;
#define DDRB_BOARD 0b0000111;
...
#define BATT_ADC_CH 1	// use VCC for AREF, use ADC1 for input (PA1), MUX bit 0:0:0:0:0
#define TEMP_ADC_CH 1	// use VCC for AREF, use ADC1 for input (PA1), MUX bit 0:0:0:0:0

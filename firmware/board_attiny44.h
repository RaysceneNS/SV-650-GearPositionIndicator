...
#define BATT_ADC_CH 0b00000000	// use VCC for AREF, use ADC0 for input (PA0), MUX 5:0 bits 00000
#define TEMP_ADC_CH 0b00000001	// use VCC for AREF, use ADC1 for input (PA1), MUX 5:0 bits 00001
#define GEAR_ADC_CH 0b00000010	// use VCC for AREF, use ADC2 for input (PA2), MUX 5:0 bits 00010
